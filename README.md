...
No AI was used to write the code. Claude Code (Fable 5) drafted and edited this README. GPT-5.6 (sol, medium) added finishing touches to handwritten notes and comments in the notebooks.
